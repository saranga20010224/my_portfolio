      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <motion.div 
            ...
            className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950/60 border border-blue-200/80 dark:border-blue-800/70 text-xs font-semibold text-blue-800 dark:text-blue-300 shadow-xs mb-5 animate-pulse-subtle"
          >
          ...
          <motion.h1 
            ...
            className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-tight sm:leading-tight md:leading-[1.15] max-w-4xl mx-auto"
          >
          ...
          <motion.p 
            ...
            className="mt-3 text-base sm:text-lg md:text-xl font-bold text-slate-700 dark:text-slate-200 tracking-tight"
          >
          ...
          <motion.p 
            variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.6 } } }}
            className="mt-3 text-base sm:text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed font-normal"
          >
          ...
          <motion.div 
            ...
            className="mt-5 inline-flex items-center space-x-2.5 p-3 px-5 rounded-2xl bg-white/80 dark:bg-slateDark-850/80 border border-slate-200/80 dark:border-slate-800 text-xs sm:text-sm text-slate-700 dark:text-slate-300 shadow-xs backdrop-blur-sm max-w-2xl mx-auto"
          >
          ...
          <motion.div 
            ...
            className="mt-8 pt-5 border-t border-slate-200/70 dark:border-slate-800/80 inline-flex items-center space-x-6 text-slate-500 dark:text-slate-400 text-xs"
          >
            <span className="font-semibold uppercase tracking-wider text-[11px]">Connect:</span>
            
            <div className="flex items-center space-x-3">
              <a href={PROFILE_DATA.contact.linkedIn} target="_blank" rel="noopener noreferrer" className="p-2 rounded-xl text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-white dark:hover:bg-slate-800 transition-colors shadow-xs">
                <Linkedin className="w-4 h-4" />
              </a>
              <a href={PROFILE_DATA.contact.gitHub} target="_blank" rel="noopener noreferrer" className="p-2 rounded-xl text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-white dark:hover:bg-slate-800 transition-colors shadow-xs">
                <Github className="w-4 h-4" />
              </a>
              <a href={`mailto:${PROFILE_DATA.contact.email}`} className="p-2 rounded-xl text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-white dark:hover:bg-slate-800 transition-colors shadow-xs">
